...
import { MerkleProof, networkForChain } from '@railgun-community/shared-models';
import { sendMessage } from '../../utils';

export const MOCK_LIST_KEY = 'test_list';

export class TempTestPOINodeInterface extends POINodeInterface {
  ...
  isActive(chain: Chain): boolean {
    return TempTestPOINodeInterface.getPOISettings(chain) != null;
  }
  ...
  private async getPOIMerkleProofs(
    ...
    const { launchBlock } = TempTestPOINodeInterface.getPOISettings(chain);
