...
const MOCKED_SHIELD_TRX: TransactionHistoryItem = {
  ...
  blockNumber: 100,
  transferERC20Amounts: [] as RailgunSendERC20Amount[],
  changeERC20Amounts: [] as RailgunSendERC20Amount[],
  receiveERC20Amounts: [
    {
      tokenAddress: '0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270',
  ...
  unshieldERC20Amounts: [] as RailgunUnshieldERC20Amount[],
  receiveNFTAmounts: [] as RailgunReceiveNFTAmount[],
  transferNFTAmounts: [] as RailgunSendNFTAmount[],
  unshieldNFTAmounts: [] as RailgunUnshieldNFTAmount[],
  version: 0,
